  ...
  export default {
    ...
    methods: {
      async savePage () {
        ...
        try {
          await eXo.$pageLayoutService.updatePageLayout(this.$root.pageRef, layoutToUpdate, 'contentId', true);
          const sectionContent = await eXo.$sectionTemplateService.generateSectionTemplateContent(this.$root.sectionTemplateId);
