  ...
  export default {
    ...
    methods: {
      ...
      deleteNode () {
        ...
        eXo.$navigationLayoutService.deleteNode(this.navigationNode.id, deleteDelay)
          .then(() => {
      ...
      editLayout () {
        return eXo.$pageLayoutService.editPageLayout(this.nodeId, this.pageRef);
      },
      ...
      pasteNode () {
        ...
        if (this.pasteMode === 'Cut') {
          eXo.$navigationLayoutService.moveNode(this.nodeToPaste.id, this.navigationNode.id, null).then(() => {
      ...
      pasteCopiedNode (navigationNodeId, nodeToPaste) {
        ...
        eXo.$navigationLayoutService.getNodeLabels(nodeToPaste.id)
          .then(data => {
            this.nodeLabels = {
              labels: data.labels,
            };
          ...
          .then(() => {
            eXo.$navigationLayoutService.createNode(navigationNodeId, null, nodeToPaste.label, nodeToPaste.name, nodeToPaste.icon, visible, isScheduled, startScheduleDate, endScheduleDate, this.nodeLabels?.labels, pageRef, nodeToPaste.target, isPasteMode)
              .then(createdNode => {
      ...
      undoDeleteNode (nodeId, successMsg) {
        return eXo.$navigationLayoutService.undoDeleteNode(nodeId)
          .then(() => {
            this.$root.$emit('refresh-navigation-nodes');
