...
<script>
  export default {
    ...
    computed: {
      ...
      startScheduleDateValue: {
        get () {
          return this.startScheduleDate;
        },
        set (value) {
          this.$emit('start-date', value);
        },
      },
      endScheduleDateValue: {
        get () {
          return this.endScheduleDate;
        },
        set (value) {
          this.$emit('end-date', value);
        },
      },
      startScheduleTimeValue: {
        get () {
          return this.startScheduleTime;
        },
        set (value) {
          this.$emit('start-time', value);
        },
      },
      endScheduleTimeValue: {
        get () {
          return this.endScheduleTime;
        },
        set (value) {
          this.$emit('end-time', value);
        },
      },
    },
    watch: {
