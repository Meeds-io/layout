    ...
    <template #footer>
      <div
        ...
        <div
          ...
          <v-icon class="icon-default-color mb-5" size="40">far fa-hourglass</v-icon>
...
<script>
  export default {
    ...
    computed: {
      ...
      sectionType () {
        return eXo.$layoutUtils.getSection(this.$root.layout, this.parentId)?.template;
      },
      isDynamicSection () {
