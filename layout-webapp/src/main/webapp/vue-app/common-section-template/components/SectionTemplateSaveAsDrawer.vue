  ...
  export default {
    ...
    methods: {
      ...
      async save () {
        this.saving = true;
        try {
          const sectionTemplate = await eXo.$sectionTemplateService.saveAsSectionTemplate(this.pageRef, this.containerId);
          eXo.$translationService.saveTranslations('sectionTemplate', sectionTemplate.id, 'title', this.titleTranslations);
          eXo.$translationService.saveTranslations('sectionTemplate', sectionTemplate.id, 'description', this.descriptionTranslations);
